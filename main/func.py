    ...
    try:
        while True:
            ...
            if frame_count % frame_chunk_size == 0:
                ...
                chunk_index += 1
                chunk_filename = f"{folder_name}_part{chunk_index}.mp4.part"
...
def merge_video_cv2(s3_client, bucket_name, chunk_keys, merged_key):
    ...
    try:
        ...
        merged_local_path = os.path.join(temp_dir, "merged_output.mp4.merged")
        fourcc = cv2.VideoWriter_fourcc(*'mp4v')
